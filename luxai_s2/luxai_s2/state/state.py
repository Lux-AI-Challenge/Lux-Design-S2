...
from luxai_s2.unit import Unit, UnitCargo, FactionTypes, UnitType
...
class State:
    ...
    @classmethod
    def from_obs(cls, obs, env_cfg: EnvConfig):
        ...
        existing_map = GameMap(np.array(obs['board']['rubble']), np.array(obs['board']['ice']), np.array(obs['board']['ore']), None)
